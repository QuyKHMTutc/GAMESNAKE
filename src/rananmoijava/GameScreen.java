...
public class GameScreen extends JPanel implements Runnable {
    ...
    public void painBG(Graphics g) {
        ...
        g.fillRect(0, 0, WIDTH + padding * 2 + 500, HEIGH + padding * 2);
        for (int i = 0; i < 20; i++) {
            for (int j = 0; j < 20; j++) {
    ...
    private void VeKhung(Graphics g) {
        ...
        g.drawRect(0, 0, WIDTH + padding * 2 + 500, HEIGH + padding * 2);
        g.drawRect(1, 1, WIDTH + padding * 2 - 2 + 500, HEIGH + padding * 2 - 2);
        g.drawRect(2, 2, WIDTH + padding * 2 - 4 + 500, HEIGH + padding * 2 - 4);
    }
    ...
    public void paint(Graphics g) {
        ...
        // điểm
        g.setFont(g.getFont().deriveFont(28.0f));
        g.drawString(" Điểm:  " + diem, 450, 150);
    }
}